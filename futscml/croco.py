...
from futscml.blocks import Block, DecoderBlock, PatchEmbed
from futscml.pos_embed import get_2d_sincos_pos_embed, RoPE2D
from futscml.masking import RandomMask
...
class CroCoNet(nn.Module):
    ...
    def forward(self, img1, img2, is_tst=False, do_mask=True):
        """
        ...
        feat1, pos1, mask1 = self._encode_image(img1, do_mask=do_mask)
        ...
        if is_tst:
            return self.unpatchify(out), self.unpatchify(einops.repeat(mask1, 'b c -> b c l', l = out.shape[-1]))
